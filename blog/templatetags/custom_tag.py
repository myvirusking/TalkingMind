    ...
    if len(reply_comment)>0:
        for replied_to_comment in reply_comment:
            result_comment+= '<li class="media" >\
                ...
                </li>'.format(replied_to_comment.author.first_name, replied_to_comment.author.last_name, replied_to_comment.commented_text, replied_to_comment.id, parent_id, rootId )
            print(parent_id)
